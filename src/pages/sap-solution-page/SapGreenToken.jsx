...
const SapGreenToken = () => {
  return (
    <div className="max-w-7xl mx-auto px-4 py-24 text-gray-800">
      <h1 className="text-4xl font-bold mb-8 text-green-700">SAP Green Token</h1>

      <p className="mb-6">
        <strong>Enhancing sustainability and traceability in your supply chain.</strong>
      </p>
      ...
      <h2 className="text-2xl font-semibold text-green-700 mb-4 mt-10">Key Benefits of SAP Green Token</h2>
      <ul className="list-disc list-inside space-y-2 mb-6">
        <li><strong>Enhanced traceability:</strong> Track the origin and sustainability of raw materials with precision.</li>
        <li><strong>Regulatory compliance:</strong> Ensure compliance with standards such as ISCC, REDcert, and EUDR.</li>
        <li><strong>Operational efficiency:</strong> Integrate seamlessly with your existing ERP systems, including SAP ECC, SAP S/4HANA, or non-SAP platforms.</li>
        <li><strong>Transparency:</strong> Provide stakeholders with verifiable data on the sustainability of your products.</li>
      </ul>

      <h2 className="text-2xl font-semibold text-green-700 mb-4">SAP Green Token Combines Three Innovative Principles</h2>
      ...
      <div className="space-y-6">
        ...
        <div>
          <h3 className="text-xl font-bold text-green-600">2. Blockchain Technology</h3>
          <p>
        ...
        <div>
          <h3 className="text-xl font-bold text-green-600">3. Mass Balance Accounting</h3>
          <p>
      ...
      <h2 className="text-2xl font-semibold text-green-700 mt-12 mb-4">EUDR Compliance Readiness</h2>
      <p className="mb-6">
