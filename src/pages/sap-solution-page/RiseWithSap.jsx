...
const RiseWithSap = () => {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-24 text-gray-800">
      ...
      <p className="mb-6">
        Of course, there’s no singular path forward, while still every business is moving forward.
        And every SAP customer is at a different point. That’s why SAP has launched its holistic
        offering as a Business Transformation-as-a-Service that is executed in close cooperation
        with its partners like Westernacher Consulting.
      </p>
      ...
      <p className="mb-6">
        A game changer is the ability to migrate into the cloud (Private Edition) using brownfield or
        selective transition approaches. Westernacher Consulting supports with proven best
        practices to determine the right strategy for your needs.
      </p>
