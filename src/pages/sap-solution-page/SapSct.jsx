...
const SapSct = () => {
  return (
    <div className="max-w-7xl mx-auto px-4 py-24 text-gray-800">
      ...
      <p className="mb-6">
        SAP Sustainability Control Tower (SCT) is a comprehensive, cloud-based platform that helps businesses monitor,
        manage, and optimize their environmental, social, and governance (ESG) performance in real time. It acts as a
        centralized hub for sustainability data, allowing organizations to comply with regulations, reduce carbon
        footprints, and drive sustainable growth.
      </p>

      <p className="mb-6">
        With growing global emphasis on sustainability reporting frameworks like the CSRD, EU Taxonomy, ISSB, and TCFD,
        businesses need automated, data-driven solutions to simplify compliance, track ESG performance, and turn
        sustainability goals into action. SAP SCT is the answer.
      </p>
      ...
      <ul className="space-y-4 list-disc list-inside">
        <li>
          <strong>Fragmented Data & Manual Processes:</strong> Sustainability data is scattered across multiple systems,
          making reporting inefficient and error-prone.
        </li>
        <li>
          <strong>Regulatory Compliance Complexity:</strong> New global regulations require comprehensive sustainability
          disclosures, increasing compliance pressure.
        </li>
        <li>
          <strong>Lack of Actionable Insights:</strong> Organizations struggle to turn sustainability data into business
          impact, missing opportunities to drive real change.
        </li>
      </ul>
